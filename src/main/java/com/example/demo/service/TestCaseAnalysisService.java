...
public interface TestCaseAnalysisService {
    ...
    String generateAnalysisAndSuggestions(String api, String test);

    String OptimizedScript(String test, TestCaseResultDto testResult) throws JsonProcessingException;
}